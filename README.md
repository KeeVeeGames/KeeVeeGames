...
- 👨‍💻 Currently working on GooWee.gml [<sup>?</sup>](javascript:; "Advanced and clean GUI framework inspired by WPF and Unity GUI") and GmProto [<sup>?</sup>](javascript:; "Protobuf / flatbuffers-esque serialization protocol")
